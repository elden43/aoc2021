...
$boardsManager = new \AOC\Commons\Day4\BingoBoardManager(\AOC\Commons\Day4\BingoBoardManager::GAME_MODE_FIRST);
...
foreach ($numbers as $number) {
	...
	if ($boardsManager->gameState === \AOC\Commons\Day4\BingoBoardManager::GAME_STATE_ENDED) {
